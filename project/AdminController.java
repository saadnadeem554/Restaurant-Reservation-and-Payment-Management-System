...
public class AdminController {
	...
	protected class ReservationDetails{
    ...
    DatabaseHandler dbb;
    public AdminController(DatabaseHandler db) {
         ash = new AdminServiceHandler(db);
         dbb = db;
    }
    ...
    public void setDatabaseHandler(DatabaseHandler db) {
        this.ash = new AdminServiceHandler(db);
    }
        ...
        result.ifPresentOrElse(password -> {
            if (isPasswordCorrect(password)) {
                ...
                try {
                    ...
                    loader.setControllerFactory(param -> new AdminController(dbb));
